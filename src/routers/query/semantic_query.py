...
async def semantic_search_endpoint( query: str, semantic: Annotated[SemanticSearch, FromDishka()]) -> List[SemanticSearchResult]:
...
async def hybrid_search_endpoint(query:str, semantic: Annotated[SemanticSearch, FromDishka()])->List[SemanticSearchResult]:
...
async def knn_multiMatch_endpoint(query: str, semantic: Annotated[SemanticSearch, FromDishka()])->List[SemanticSearchResult]:
